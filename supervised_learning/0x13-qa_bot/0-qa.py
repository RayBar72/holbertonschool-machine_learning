...
def question_answer(question, reference):
    ...
    answer a question
    """
    tipo = 'bert-large-uncased-whole-word-masking-finetuned-squad'
    tokenizer = BertTokenizer.from_pretrained(tipo)
    model = TFBertForQuestionAnswering.from_pretrained(tipo)
